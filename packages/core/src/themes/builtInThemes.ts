...
:root {
  ...
  --dok-bg: rgba(255, 255, 255, 0.75);
  --dok-border: rgba(255, 255, 255, 0.4);
...
:root {
  ...
  --slide-radius: 4px;
  --slide-shadow: none;
  --dok-bg: rgba(255, 255, 255, 0.8);
  --dok-border: rgba(55, 53, 47, 0.15);
  --progress-bg: rgba(55, 53, 47, 0.05);
}
body {
...
.slideTitle { font-weight: 700; letter-spacing: -0.02em; }`,
...
.slideTitle { text-shadow: 0 0 20px rgba(0,255,65,0.6); }
.slideContent pre { border: 1px solid rgba(0,255,65,0.2); }`,
...
:root {
  ...
  --dok-bg: rgba(15, 12, 41, 0.7);
  --dok-border: rgba(167, 139, 250, 0.2);
  --progress-bg: rgba(255, 255, 255, 0.1);
}
body {
...
.slideContent pre { background: rgba(255,255,255,0.05); border: 1px solid rgba(167,139,250,0.2); }
.slideContent blockquote { border-left-color: #a78bfa; }`,
};
